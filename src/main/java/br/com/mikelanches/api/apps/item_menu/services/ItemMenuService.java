package br.com.mikelanches.api.apps.item_menu.services;
...
import br.com.mikelanches.api.apps.item_menu.repositories.ItemMenuRepository;
import br.com.mikelanches.api.shared.dto.PageableListDTO;
import br.com.mikelanches.api.shared.dto.ResponseMessageDTO;
...
public class ItemMenuService {
    ...
    public PageableListDTO<ItemMenuListDTO> getAllItensMenu(int page, int pageOrder) {

        // Fetch paginated data from the repository
        Page<ItemMenuModel> itemMenuPage = itemMenuRepository.findAll(PageRequest.of(page, 10));

        System.out.println(itemMenuPage.getContent());

        // List dto pages
        List<ItemMenuListDTO> user = new ArrayList<>();
        ...
        PageableListDTO<ItemMenuListDTO> data = new PageableListDTO<>(user, itemMenuPage.getTotalElements());
    ...
    public ResponseEntity<?> createItemMenu(ItemMenuAllDTO itemMenu, MultipartFile file) {
        ...
        try {
            ...
            // Converting the saved UserModel back to DTO
            ItemMenuAllDTO itemMenuDTO = new ItemMenuAllDTO();
